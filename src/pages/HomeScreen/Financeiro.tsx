...
export default function Financeiro() {
  ...
  const [pagamentos, setPagamentos] = useState<Pagamento[]>([
    { id: 1, descricao: 'Mensalidade Agosto', valor: 'R$ 200', status: 'Pendente', vencimento: '10/08/2025' },
    { id: 2, descricao: 'Mensalidade Julho', valor: 'R$ 200', status: 'Pago', vencimento: '10/07/2025' },
    { id: 3, descricao: 'Aula Extra', valor: 'R$ 50', status: 'Pendente', vencimento: '15/08/2025' },
  ]);
